...
class SignUpScreenEstablishment extends StatelessWidget {
  ...
  Future<dynamic> createAlbum(BuildContext context) async {
    List<String> words = controlsTextOneController.value.text.split(" ");
                        ...
                        child: Column(
                            ...
                            children: [
                              Container(
                                  ...
                                  child: Text("Establishment Owner Information",
                                      maxLines: null,
